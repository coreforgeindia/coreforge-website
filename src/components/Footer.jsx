        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_1fr_1fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-sm text-xs leading-6 text-neutral-400">
              Practical engineering for students, startups, and businesses: embedded systems, PCB design, custom software, and technical support.
            </p>
          ...
          {/* Column 4: Reach Us & Small Map Embed */}
          <div>
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-neutral-500">Reach Us</p>
            ...
            <div className="mt-4 overflow-hidden rounded-xl border border-white/10">
              <iframe
                ...
                title="CoreForge HQ Location Map"
              />
            </div>
          </div>
        </div>

        <div className="mt-10 border-t border-white/10 pt-6 flex items-center justify-between text-xs text-neutral-500">
          <p>© 2026 CoreForge. All rights reserved.</p>
