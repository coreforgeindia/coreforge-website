...
export default function EmptyState({ title = 'Nothing here yet', message = 'There is no content to display at the moment.', action, actionLabel = 'Go Home' }) {
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      ...
      >
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-neutral-100">
          <HiOutlineInbox className="h-10 w-10 text-neutral-400" />
        </div>
